...
//
//	static void SetInputs(bool state, unsigned long long input_code);
//	static void SetInputs(bool state, unsigned long long data1, long long data2);
//	static void SetScroll(unsigned long long data1, long long data2);
//	static void SetMousePos(long long data);
